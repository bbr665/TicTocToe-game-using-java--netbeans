 ...
 * @author sriram
 */
public class TicTocToe_s extends javax.swing.JFrame {
    private String startGame ="X";
    private int xcount = 0;
    private int ocount= 0;

    /**
     * Creates new form TicTocToe_s
     */
    public TicTocToe_s() {
        initComponents();
        setSize(1200,600);
    ...
    private void winningGame()
    {
        ...
        if (b1==("X")&& b2==("X")&& b3==("X"))
        {
            JOptionPane.showMessageDialog(this,"Player X wins","Tic Toc Toe",JOptionPane.INFORMATION_MESSAGE);
            xcount++;
            gameScore();
        ...
        if (b1==("O")&& b2==("O")&& b3==("O"))
        {
            JOptionPane.showMessageDialog(this,"Player O wins","Tic Toc Toe",JOptionPane.INFORMATION_MESSAGE);
            ocount++;
            gameScore();
            jButton1.setBackground(Color.YELLOW);
            jButton2.setBackground(Color.YELLOW);
...
private JFrame frame;
    private void jbtnExitActionPerformed(java.awt.event.ActionEvent evt) {                                         
      ...
      if(JOptionPane.showConfirmDialog(frame,"Confirm if you want to exit","Tic Toc Toe",
...
jButton9.setText(startGame);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TicTocToe_s.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TicTocToe_s().setVisible(true);
            }
        });
    }
